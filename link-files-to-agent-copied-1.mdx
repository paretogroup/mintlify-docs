---
title: "Vincular Arquivos ao Agente "
description: "Vincula um arquivo para ser associado a um agente específico."
...
| **Parâmetro** | **Tipo** | **Obrigatório** | **Descrição**  |
| :------------ | :------- | :-------------- | :------------- |
| agentId       | string   | Sim             | O ID do agente |

### **Parâmetros do Corpo**

| **Parâmetro** | **Tipo** | **Obrigatório** | **Descrição**                               |
| :------------ | :------- | :-------------- | :------------------------------------------ |
| file_ids      | array    | Sim             | Os IDs dos arquivos para vincular ao agente |
