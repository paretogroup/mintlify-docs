...
| **Parameter**     | **Type** | **Required** | **Description**                                                                                                          |
| :---------------- | :------- | :----------- | :----------------------------------------------------------------------------------------------------------------------- |
| `stream`          | boolean  | No           | Streams the output using the Server-Sent Events (SSE) format. Default: `false`.                                          |
...
| *(custom fields)* | any      | No           | Additional agent-specific inputs. Any extra fields are passed through to the agent.                                      |
