...
| **Parâmetro** | **Tipo** | **Obrigatório**            | **Descrição**                                                          |
| :------------ | :------- | :------------------------- | :--------------------------------------------------------------------- |
| stream        | boolean  | Não                        | Transmite a saída usando o formato Server-Sent Events. Padrão: `false` |
| answers       | object   | Sim                        | As respostas do agente                                                 |
| messages      | array    | Apenas para Agente de Chat | As mensagens do agente                                                 |
| file_ids      | array    | Não                        | Array de IDs de arquivos para anexar à execução.                       |
