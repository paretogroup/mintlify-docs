---
title: "Criar Webhook do Agente "
description: "Cria um novo webhook para um agente específico."
...
| :------------ | :------- | :-------------- | :------------- |
| id            | string   | Sim             | O ID do agente |

### **Parâmetros do Corpo**

| **Parâmetro** | **Tipo** | **Obrigatório** | **Descrição**                          |
| :------------ | :------- | :-------------- | :------------------------------------- |
| url           | string   | Sim             | A URL do webhook                       |
| method        | string   | Não             | O método HTTP (GET, POST, etc.)        |
| status        | string   | Não             | O status do webhook (active, inactive) |
