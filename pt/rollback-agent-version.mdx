...
description: "Restaura uma versão específica do agente criando uma nova versão cujo snapshot corresponde ao alvo. O histórico de versões é preservado — nenhuma versão é excluída. O rollback é registrado como auditoria. Requer a permissão `agent:version:read`."
