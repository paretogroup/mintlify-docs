...
description: "Recupera una lista paginada de archivos con opciones de ordenación."
api: "GET https://api.tess.im/files"
authMethod: "bearer"
...
| sort_by       | string   | No            | Campo para ordenación (created_at, updated_at, filename, size)          |
| sort_order    | string   | No            | Orden de ordenación (asc, desc)                                         |
