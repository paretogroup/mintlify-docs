...
<ParamField header="x-workspace-id" type="entero">
  ID del espacio de trabajo. Si no se proporciona, se utilizará el espacio de trabajo seleccionado por el usuario.
</ParamField>
