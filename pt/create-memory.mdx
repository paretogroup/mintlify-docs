---
title: "Criar Memória "
description: "Cria uma nova memória para o usuário autenticado."
...
| :------------ | :------- | :-------------- | :----------------------------- |
| content       | string   | Sim             | O conteúdo da memória          |
| metadata      | object   | Não             | Metadados associados à memória |
