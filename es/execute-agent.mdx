...
<ParamField body="wait_execution" type="boolean">
  Indica si la ejecución debe esperar hasta completarse. El tiempo de espera es de 100 segundos. Para ejecuciones más largas, use wait_execution=false en combinación con el endpoint Obtener Respuesta del Agente con una estrategia de sondeo (predeterminado: false).
</ParamField>
