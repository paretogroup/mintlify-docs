...
<Columns cols={2}>
  <Card icon="1" title="Entrada do Usuário">
    O usuário fornece o material inicial (ex: arquivo PDF, uma URL de um site). Isso a depender da configuração prevista.
  </Card>
  ...
  <Card icon="4" title="Geração da Resposta Final">
    A IA, agora com as informações necessárias, executa o seu prompt principal (ex: "Crie uma descrição de produto com base no texto extraído") e entrega o resultado.
  </Card>
</Columns>
