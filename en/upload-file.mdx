...
<Warning>
  The playground does not support `multipart/form-data` uploads directly. Use the **Code Examples** above (cURL, Python, Node.js, etc.) to send the actual file. The fields below are shown for documentation purposes only.
</Warning>
...
<ParamField body="process" type="boolean">
  Whether to process the file after upload (default: false). File processing consumes credits (true).
</ParamField>
