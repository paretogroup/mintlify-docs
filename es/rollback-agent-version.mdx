...
description: "Restaura una versión específica del agente creando una nueva versión cuyo snapshot coincide con el objetivo. El historial de versiones se preserva (no se elimina ninguna versión) y el rollback queda registrado para auditoría. Tu rol en el workspace debe permitir revertir versiones del agente."
api: "POST https://api.tess.im/agents/{id}/versions/{version_id}/rollback"
authMethod: "bearer"
