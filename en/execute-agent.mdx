...
<ParamField body="temperature" type="string">
  Sampling temperature between 0 and 2. Higher values produce more creative outputs (default: `"1"`).
</ParamField>
<ParamField body="model" type="string">
  Model identifier to use for execution (e.g., `"tess-6"`).
</ParamField>
<ParamField body="tools" type="string">
  Tool configuration for the agent (e.g., `"agent"`, `"no-tools"`).
</ParamField>
<ParamField body="root_id" type="integer">
  ID of an existing execution to continue a conversation thread.
</ParamField>
<ParamField body="messages" type="array">
  The agent messages. Required for Chat Agent type templates. Supports `user`, `assistant`, and `developer` roles.
</ParamField>
