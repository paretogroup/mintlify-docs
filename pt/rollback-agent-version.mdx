...
description: "Restaura uma versão específica do agente criando uma nova versão cujo snapshot corresponde ao alvo. O histórico de versões é preservado (nenhuma versão é excluída) e o rollback fica registrado para auditoria. Seu papel no workspace precisa permitir reverter versões do agente."
