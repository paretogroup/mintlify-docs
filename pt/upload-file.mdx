...
api: "POST https://api.tess.im/files"
authMethod: "bearer"
...
<Warning>
  O playground não suporta uploads `multipart/form-data` diretamente. Use os **Exemplos de Código** acima (cURL, Python, Node.js, etc.) para enviar o arquivo. Os campos abaixo são exibidos apenas para documentação.
</Warning>

<ParamField body="file" type="file" required>
  O arquivo a ser enviado (multipart/form-data)
</ParamField>
<ParamField body="process" type="boolean">
  Se deve processar o arquivo após o upload (padrão: false). O processamento consome créditos (true).
</ParamField>
