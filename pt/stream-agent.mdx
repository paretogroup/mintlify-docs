...
| **Parâmetro**      | **Tipo** | **Obrigatório** | **Descrição**                                                                                                               |
| :----------------- | :------- | :-------------- | :-------------------------------------------------------------------------------------------------------------------------- |
| `stream`           | boolean  | Não             | Transmite a saída usando o formato Server-Sent Events (SSE). Padrão: `false`.                                               |
...
| *(campos custom)*  | any      | Não             | Inputs dinâmicos específicos do agente. Campos adicionais são repassados diretamente ao agente.                             |
