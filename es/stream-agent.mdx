...
| **Par?metro**       | **Tipo** | **Requerido** | **Descripci?n**                                                                                                              |
| :------------------ | :------- | :------------ | :--------------------------------------------------------------------------------------------------------------------------- |
| `stream`            | boolean  | No            | Transmite la salida usando el formato Server-Sent Events (SSE). Predeterminado: `false`.                                     |
...
| *(campos custom)*   | any      | No            | Inputs din?micos espec?ficos del agente. Los campos adicionales se pasan directamente al agente.                              |
