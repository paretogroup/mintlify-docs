...
<ParamField header="Authorization" type="string">
  Token Bearer (chave de API). O token deve incluir a ability use_agents.
</ParamField>
...
<ParamField header="Accept" type="string">
  Use application/json se o cliente precisar declarar explicitamente JSON.
</ParamField>
...
<ParamField query="start_date" type="date (AAAA-MM-DD)">
  Início do intervalo (inclusivo). Obrigatório com end_date.
</ParamField>
<ParamField query="end_date" type="date (AAAA-MM-DD)">
